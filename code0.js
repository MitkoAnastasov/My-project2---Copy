...
for(var i = 0, k = 0, l = gdjs.GameCode.GDPlayerObjects1.length;i<l;++i) {
    if ( gdjs.GameCode.GDPlayerObjects1[i].getVariableString(gdjs.GameCode.GDPlayerObjects1[i].getVariables().getFromIndex(1)) == "off" ) {
        gdjs.GameCode.condition1IsTrue_0.val = true;
...
{for(var i = 0, len = gdjs.GameCode.GDPlayerObjects1.length ;i < len;++i) {
    gdjs.GameCode.GDPlayerObjects1[i].returnVariable(gdjs.GameCode.GDPlayerObjects1[i].getVariables().getFromIndex(1)).setNumber(0);
}
}}
